;(function webpackUniversalModuleDefinition (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') {
    ...
    exports['ReactAutocomplete'] = factory(
      require('react'),
      require('react-dom')
    )
  } else {
            ...
            },
            {
              ...
              value: function componentWillReceiveProps (nextProps) {
                var searchTerm = nextProps.searchTerm
                  ...
                  : nextProps.value ? nextProps.value.title : ''
        ...
        */
        ...
        var _initialiseProps = function _initialiseProps () {
          ...
          this.showResults = function (searchTerm) {
            ...
            _this4.props.search(
              _this4.props.options,
              searchTerm.trim(),
              _this4.onSearchComplete
            )
          }

          this.showAllResults = function () {
            if (
              !_this4.state.showResultsInProgress &&
              !_this4.state.showResults
            ) {
              _this4.showResults('')
            }
          }
            ...
            if (e.key === 'Enter') {
              ...
              if (_this4.state.showResults) {
                var nextIdx = Math.min(
                  _this4.focusedValueIndex() +
                    (_this4.state.showResults ? 1 : 0),
                  _this4.state.results.length - 1
                )
                _this4.setState({
                  showResults: true,
          ...
          this.focusedValueIndex = function () {
            ...
            for (var i = 0, len = _this4.state.results.length; i < len; i++) {
              if (
                _this4.getResultIdentifier(_this4.state.results[i]) ===
                _this4.getResultIdentifier(_this4.state.focusedValue)
              ) {
                return i
              }
            }
          ...
          function Results () {
            ...
            return (
              (_ret = ((_temp = ((_this2 = _possibleConstructorReturn(
                ...
                (_ref =
                  Results.__proto__ ||
                  Object.getPrototypeOf(Results)).call.apply(
                  _ref,
                  [this].concat(args)
                )
              )),
              _this2)),
              (_this2.getResultIdentifier = function (result) {
                if (_this2.props.resultIdentifier === undefined) {
                  if (!result.id) {
                    throw Error(
                      'id property not found on result. You must specify a resultIdentifier and pass as props to autocomplete component'
                    )
                  }
                  return result.id
                } else {
              ...
              (_this2.renderResult = function (result) {
                var focused =
                  _this2.props.focusedValue &&
                  _this2.getResultIdentifier(_this2.props.focusedValue) ===
                    _this2.getResultIdentifier(result)
          ...
          function Result () {
            ...
            return (
              (_ret2 = ((_temp2 = ((_this3 = _possibleConstructorReturn(
                this,
                (_ref2 =
                  Result.__proto__ || Object.getPrototypeOf(Result)).call.apply(
                  _ref2,
                  [this].concat(args)
                )
              )),
              _this3)),
              (_this3.getLabel = function (result) {
